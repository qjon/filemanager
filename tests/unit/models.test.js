describe('models.js', function () {
    ...
    describe('DirsStructure', function () {
        ...
        beforeEach(inject(function($injector){
            ...
            $httpBackend.expectGET('/data/directory.json')
                .respond({"dirs":[{"id":1,"name":"Katalog"},{"id":2,"name":"Katalog o bardzo długiej nazwie"}],"files":[{"id":1,"name":"Dino 1","src":"/data/images/IMG_5549.JPG","mime":"image/jpg"},{"id":10,"name":"Dino 2","src":"/data/images/IMG_5554.JPG","mime":"image/jpg"},{"id":11,"name":"Dino 3","src":"/data/images/IMG_5559.JPG","mime":"image/jpg"},{"id":2,"name":"Dino 4","src":"/data/images/IMG_5565.JPG","mime":"image/jpg"},{"id":4,"name":"Dino 5","src":"/data/images/IMG_5567.JPG","mime":"image/jpg"},{"id":7,"name":"Dino 6","src":"/data/images/IMG_5568.JPG","mime":"image/jpg"},{"id":8,"name":"Dino 7","src":"/data/images/IMG_5573.JPG","mime":"image/jpg"},{"id":21,"name":"Dino 8","src":"/data/images/IMG_5583.JPG","mime":"image/jpg"},{"id":22,"name":"Dino 9","src":"/data/images/IMG_5584.JPG","mime":"image/jpg"},{"id":34,"name":"Dino 10","src":"/data/images/IMG_5585.JPG","mime":"image/jpg"},{"id":112,"name":"Dino 11","src":"/data/images/IMG_5588.JPG","mime":"image/jpg"},{"id":100,"name":"Dino 12","src":"/data/images/IMG_5590.JPG","mime":"image/jpg"},{"id":50,"name":"Przykładowy PDF","src":"/data/pdf/przykladowy_pdf.pdf","mime":"application/pdf"}]})
            ;
            DirStructure.load(0);
            $httpBackend.flush();
        }));
