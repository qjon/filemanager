describe('controllers.js', function () {
    ...
    describe('MainCtrl:', function () {
        ...
        describe('functions:', function () {
            ...
            describe('goFolderUp:', function () {
                it('should call $state.go with dirId equal 2', function () {
                    spyOn($state, 'go');
                    $scope.currentDir = {
                        id: 5,
                        parentId: 2
                    ...
                    $scope.goFolderUp();
                    expect($state.go).toHaveBeenCalledWith('main', {dirId: 2});
                });
            });
        });
    ...
    describe('RemoveDirCtrl:', function () {
        var $scope, $rootScope, createMainCtrl, $state, DirStructure, $httpBackend, LastState;
        ...
        beforeEach(inject(function($injector){
            ...
            createMainCtrl = function(){
                return $controller('RemoveDirCtrl', {
                    '$scope': $scope,
                    '$state': $state,
                    'DirStructure': DirStructure
                })
